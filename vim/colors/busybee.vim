...
if version >= 700
  ...
  hi PmenuSel 	   guifg=#000000 guibg=#ffff00 ctermfg=0 ctermbg=148
endif
...
hi Visual		   guifg=#ffffaa guibg=#3c414c gui=none ctermfg=254 ctermbg=4
hi SpecialKey	   guifg=#808080 guibg=#343434 gui=none ctermfg=244 ctermbg=236

" Syntax highlighting
hi Comment 		   guifg=#707070 gui=italic ctermfg=244
hi Todo 		   guifg=#8f8f8f gui=none ctermfg=245
hi Boolean         guifg=#ffff00 gui=none ctermfg=148
hi String 		   guifg=#707070 gui=none ctermfg=148
hi Identifier 	   guifg=#ffff00 gui=none ctermfg=148
...
hi PreProc 		   guifg=#ffffaa gui=none ctermfg=230
